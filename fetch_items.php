...
<div style='border-bottom:1px solid #bbbfbd;width:100%;background-color:white;margin-bottom:10px;display:inline;padding-top:20px;padding-bottom: 20px;padding-left:8px;padding-right:8px'>
    ...
    while($all_found =mysqli_fetch_assoc($data))
    {
        ...
        <div style='border-bottom:1px solid #bbbfbd;width:100%;background-color:white;margin-bottom:10px;display:inline;padding-top:20px;padding-bottom: 20px;padding-left:8px;padding-right:8px'>
             ...
             <div style='color:#b9bdbb;width:15%;text-align:center;font-size:20px;display:inline-block;font-family:arial;padding-left:15px;padding-right:40px;margin-left:100px'><button style='border-radius:2px;padding-top:8px;padding-bottom:8px;'>Buy</button></div>
