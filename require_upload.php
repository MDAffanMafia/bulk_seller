...
<div class="jumbotron-dup">
  ...
  <form class="" action="upload_Reqitems.php" method="POST" >
  ...
  <div class="divla"> <label>Currency</label></div>    
   ...
   <div class="input_items">
    ...
    <input class="enter" type="number"  placeholder="Requirement" name="required_items" value="">
    </div>
    <div class="input_items">
    ...
    <div class="signupbutton">
      <button type="submit"  class ="btn btn-danger " name="upload" value="Submit" >Add Requirement</button>
    </div>
